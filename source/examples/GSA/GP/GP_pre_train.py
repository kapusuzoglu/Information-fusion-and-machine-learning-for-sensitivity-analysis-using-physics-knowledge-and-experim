...
def Gp_phy():
    ...
    kernel = C(5.0, (1e-1, 1e1)) * RBF(length_scale = [1] * uX1_pre.shape[1], length_scale_bounds=(1e-1, 1e9))
    gp1 = GaussianProcessRegressor(kernel=kernel, alpha =1.5, n_restarts_optimizer=15)
